...
/**
 *
 * @TableName aps_tfmini_s_sn_labeling
 */
@TableName(value ="aps_tfmini_s_sn_labeling")
@Data
public class ApsTfminiSSnLabelingDto implements Serializable {
    /**
     * 自增ID
     */
    @ExcelIgnore
