...
/**
 * @TableName aps_installation_board
 */
@TableName(value = "aps_installation_board")
@Data
public class ApsInstallationBoardDto implements Serializable {
    /**
     * 自增ID
     */
    @ExcelIgnore
