...
import com.benewake.system.service.mes.ApsTfminiSPcbaBurnService;
import com.benewake.system.mapper.ApsTfminiSPcbaBurnMapper;
import com.benewake.system.transfer.MesToApsTfminiSPcbaBurn;
...
/**
* @author ASUS
* @description 针对表【aps_tfmini_s_pcba_burn】的数据库操作Service实现
* @createDate 2023-10-19 09:28:12
*/
@Service
public class ApsTfminiSPcbaBurnServiceImpl extends ServiceImpl<ApsTfminiSPcbaBurnMapper, ApsTfminiSPcbaBurn>
    implements ApsTfminiSPcbaBurnService{
    ...
    public Boolean updateDataVersions() throws Exception {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            // 解析响应内容
            // 解析响应内容
            ArrayList<ApsTfminiSPcbaBurn> apsTfminiSPcbaBurns = null;
            if (response.getEntity() != null) {
                ...
                for (JsonElement element : answersArray) {
                    ...
                    for (int i = 0; i < answerArray.size(); i++) {
                        ...
                        if (fieldMapping.containsKey(queTitle)) {
                            ...
                            for (int j = 0; j < valuesArray.size(); j++) {
                                ...
                                // 通过反射设置字段值，假设MesPcbaBurn是具有对应字段的JavaBean
                                try {
                    ...
                    apsTfminiSPcbaBurns = new ArrayList<>();
                    for (MesPcbaBurn mesPcbaBurn : dataList) {
                        ApsTfminiSPcbaBurn apsTfminiSPcbaBurn = mesToApsTfminiSPcbaBurn.convert(mesPcbaBurn, maxVersionIncr);
                        apsTfminiSPcbaBurns.add(apsTfminiSPcbaBurn);
                    }
                }
            }
            return saveBatch(apsTfminiSPcbaBurns);
        } catch (IOException e) {
