...
import com.benewake.system.service.mes.ApsPackagingTestService;
import com.benewake.system.mapper.ApsPackagingTestMapper;
import com.benewake.system.transfer.MesToApsPackagingTest;
...
/**
* @author ASUS
* @description 针对表【aps_packaging_test】的数据库操作Service实现
* @createDate 2023-10-19 14:44:22
*/
@Service
public class ApsPackagingTestServiceImpl extends ServiceImpl<ApsPackagingTestMapper, ApsPackagingTest>
    implements ApsPackagingTestService{
    ...
    public Boolean updateDataVersions() throws Exception {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            ArrayList<ApsPackagingTest> apsPackagingTests = null;
            if (response.getEntity() != null) {
                ...
                for (JsonElement element : answersArray) {
                    ...
                    apsPackagingTests = new ArrayList<>();
                    for (MesPackagingTest mesPackagingTest : dataList) {
                        ApsPackagingTest apsPackagingTest = mesToApsPackagingTest.convert(mesPackagingTest, maxVersionIncr);
                        apsPackagingTests.add(apsPackagingTest);
                    }
                }
            }
            return saveBatch(apsPackagingTests);
        } catch (IOException e) {
